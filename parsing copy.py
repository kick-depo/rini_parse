...
def extract_cartridges_data(soup):
    ...
    for grid_5_div in grid_5_divs:
        ...
        for title, table in zip(analog_titles, analog_tables):
            b_tag = title.find("b")
            cartridge_name = b_tag.text if b_tag else "-"
            ...
            for row in rows:
                ...
                analog_data.append((cartridge_name, color, resource, compatible_price_1, compatible_price_10, original_price))
    ...
    for cartridge_link in get_url():
        ...
        if printer_links:
            ...
            yield (name if name else '',
                   ...
                   original_price if original_price else '',
